...
const analysisItems = [
  ...
  { href: '/influencia-eleitoral', label: '14. Influência Eleitoral', icon: MapPin },
  { href: '/base-potencial', label: '15. Base Potencial', icon: Users },
  { href: '/simulacao-deputado', label: '16. Simulação Deputado', icon: BarChart3 },
  { href: '/expansao-territorial', label: '17. Expansão', icon: TrendingUp },
  { href: '/crescimento-territorial', label: '18. Crescimento Territorial', icon: TrendingUp },
  { href: '/viabilidade', label: '19. Viabilidade', icon: Target },
  { href: '/cenarios-2026', label: '20. Cenários 2026', icon: Landmark },
  { href: '/diretrizes-campanha', label: '21. Diretrizes', icon: Users },
];
      ...
      >
        ...
        <div className="flex items-center gap-3 px-5 py-5 border-b border-slate-100">
          <div className="w-9 h-9 rounded-lg bg-blue-600 flex items-center justify-center flex-shrink-0">
            <span className="text-white font-bold text-sm" style={{ fontFamily: "'Sora', sans-serif" }}>JA</span>
          </div>
          <div className="min-w-0">
            <p className="text-sm font-bold text-slate-900 truncate" style={{ fontFamily: "'Sora', sans-serif" }}>Jamyl Asfury</p>
        ...
        <nav className="flex-1 overflow-y-auto px-3 py-4">
          <p className="text-[10px] font-semibold text-slate-400 uppercase tracking-widest px-3 mb-2">Principal</p>
          ...
          <div className="mt-5 pt-4 border-t border-slate-100">
            ...
            >
              <span className="text-[10px] font-semibold text-slate-400 uppercase tracking-widest">Análises Técnicas</span>
              <ChevronDown
                size={14}
        ...
        <div className="px-5 py-4 border-t border-slate-100 bg-slate-50">
          <p className="text-xs font-semibold text-blue-600 text-center">Deputado Estadual 2026</p>
